...
const nombreDelEquipoDeLaboratorio = "Grecia";
...
// En mazos.js se define la variable coleccionDeMazos
...
const mazos = window.coleccionDeMazos;
...
function seleccionaMazo(nombre) {
  ...
  function generaTarjetaHTML(tarjeta, index) {
    ...
    return (
      `<div class="${claseTarjetaEnLaDerecha}" id = ${index} data-index="${index}"> ` + contenidoTarjeta + "</div>"
    );
  }
